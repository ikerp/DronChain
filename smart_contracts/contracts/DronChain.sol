...
*/
    ...
    function contratarDron(uint256 dronId, uint256 parcelaId) public {
        require(!dronesContratados[dronId][parcelaId], 'El dron seleccionado ya había sido contratado para fumigar dicha parcela');
    ...
    function asignarDron(uint256 dronId, uint256 parcelaId) public {
        require(dronesContratados[dronId][parcelaId], 'El dron seleccionado no había sido contratado para fumigar dicha parcela');
